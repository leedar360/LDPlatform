...
* @version 1.0
 */
public class ObjectDoubSheetExcelView extends AbstractExcelView{
...
//		picFile = "d:/2.jpg";
		String picType = "JPG";
		String picFileType = picFile.substring(picFile.lastIndexOf("."),picFile.length());

		if (picFileType.equalsIgnoreCase(".jpg")){
			picType = "JPG";
		}
		if (picFileType.equalsIgnoreCase(".png")){
			picType = "PNG";
		}

		try{
			bufferImg = ImageIO.read( new File( picFile ) );
			ImageIO.write(bufferImg, picType, bout);

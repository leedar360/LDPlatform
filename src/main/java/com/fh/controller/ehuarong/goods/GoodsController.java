package com.fh.controller.ehuarong.goods;
...
import com.fh.service.ehuarong.goods.GoodsManager;
...
public class GoodsController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("ehuarong/goods/goods_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("ehuarong/goods/goods_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var3", varOList.get(i).getString("GOODUNIT"));	    //3
			vpd.put("var4", varOList.get(i).getString("SPEC"));	    //4
			vpd.put("var5", varOList.get(i).getString("MEMO"));	    //5
			vpd.put("var6", varOList.get(i).getString("GOODCATEGORYID"));	    //6

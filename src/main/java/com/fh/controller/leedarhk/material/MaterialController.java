package com.fh.controller.leedarhk.material;
...
import com.fh.service.leedarhk.material.MaterialManager;
...
public class MaterialController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CREATETIME", Tools.date2Str(new Date()));	//系统创建时间
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("leedarhk/material/material_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("leedarhk/material/material_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("GOOD_ID"));	    //1
			vpd.put("var2", varOList.get(i).getString("GOODSNAME"));	    //2
			vpd.put("var3", varOList.get(i).getString("PARTNAME"));	    //3
			vpd.put("var4", varOList.get(i).getString("SPEC"));	    //4
			vpd.put("var5", varOList.get(i).getString("UNITPRICE"));	    //5
			vpd.put("var6", varOList.get(i).getString("MFG"));	    //6
			vpd.put("var7", varOList.get(i).getString("MANUDATE"));	    //7
			vpd.put("var8", varOList.get(i).getString("PACKAGE"));	    //8

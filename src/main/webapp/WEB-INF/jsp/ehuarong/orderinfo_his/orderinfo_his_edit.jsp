		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="orderinfo_his/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ORDERINFO_HIS_ID" id="ORDERINFO_HIS_ID" value="${pd.ORDERINFO_HIS_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="REMARK" id="REMARK" value="${pd.REMARK}" maxlength="255" placeholder="这里输入备注21" title="备注21" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">状态，导入，采购，发货等标识位:</td>
								<td><input type="text" name="STATUS" id="STATUS" value="${pd.STATUS}" maxlength="45" placeholder="这里输入状态，导入，采购，发货等标识位" title="状态，导入，采购，发货等标识位" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">第三方平台商品描述:</td>
								<td><input type="text" name="EXTGOODS_NAME" id="EXTGOODS_NAME" value="${pd.EXTGOODS_NAME}" maxlength="255" placeholder="这里输入第三方平台商品描述" title="第三方平台商品描述" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">供应商产品名称:</td>
								<td><input type="text" name="SUPPLYGOOD_NAME" id="SUPPLYGOOD_NAME" value="${pd.SUPPLYGOOD_NAME}" maxlength="255" placeholder="这里输入供应商产品名称" title="供应商产品名称" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			if($("#SUPPLYGOOD_NAME").val()==""){
				$("#SUPPLYGOOD_NAME").tips({
					side:3,
		            msg:'请输入供应商产品名称',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#SUPPLYGOOD_NAME").focus();
			return false;
			}
			$("#Form").submit();
			$("#zhongxin").hide();

			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 检索  -->
						<form action="aftersale/list.do" method="post" name="Form" id="Form">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"
								...
								<tr>
									...
									<th class="center">售后金额</th>
									<th class="center">售后备注</th>
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
													...
													<td class='center'><a style="cursor:pointer;"
																		  onclick="openpiclist('${var.ORDERINFO_ID}');"
																		  class="tooltip-success" data-rel="tooltip"
																		  title="查看">${var.ODER_ID}</a> </td>
...
地址：${var.RECADDRESS}</textarea></td>
													...
													<td class='center'>${var.AFSALEPRICE}</td>
													<td class='center'><textarea readonly>${var.AFSALEREMARK}</textarea></td>
													...
													<td class="center">
														...
														<div class="hidden-sm hidden-xs btn-group">
															<c:if test="${QX.edit == 1 }">
																<a class="btn btn-xs btn-success" title="售后&处理"
																   onclick="afedit('${var.ORDERINFO_ID}');">
																	<i class="ace-icon fa fa-pencil-square-o bigger-120"
																	   title="发货">售后&处理</i>
																</a><br><br>
																<a class="btn btn-xs btn-success" title="售后&图片"
																   onclick="picadd('${var.ORDERINFO_ID}');">
...
<script type="text/javascript">
	...
	//新增
	function openpiclist(ID){
		top.jzts();
		var diag = new top.Dialog();
		diag.Drag=true;
		diag.Title ="售后图片列表";
		diag.URL = '<%=basePath%>aftersale/goOpenpiclist.do?ORDERINFO_ID='+ID;
		diag.Width = 800;
		diag.Height = 600;
	...
	function picadd(ID){
		...
		diag.Drag=true;
		diag.Title ="新增";
		diag.URL = '<%=basePath%>aftersale/goAdd.do?ORDERINFO_ID='+ID;
		diag.Width = 800;
		diag.Height = 490;
		diag.CancelEvent = function(){ //关闭事件
			if('${page.currentPage}' == '0'){
    ...
    function afedit(Id) {
        ...
        diag.Drag = true;
        diag.Title = "编辑";
        diag.URL = '<%=basePath%>aftersale/goEdit.do?ORDERINFO_ID=' + Id;
        diag.Width = 800;
        diag.Height = 600;

								...
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入商品名称搜索" class="nav-search-input" id="nav-search-input" autocomplete="off" name="goodName" value="${pd.goodName}" placeholder="这里输入商品名称搜索"/>

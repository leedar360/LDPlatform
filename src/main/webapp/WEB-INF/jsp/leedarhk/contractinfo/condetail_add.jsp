					...
					<form action="contractinfo/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="PROJECTCODE" id="PROJECTCODE" value="${pd.PROJECTCODE}" readonly = "readonly" maxlength="255" placeholder="这里输入项目code" title="项目code" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">合同编号:</td>
								<td><input type="text" name="PONUMBER" id="PONUMBER" value="${pd.PONUMBER}" readonly = "readonly" maxlength="255" placeholder="这里输入合同编号" title="合同编号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">子单排序:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">料号:</td>
								<td><input type="text" name="PARTNO" id="PARTNO" value="${pd.PARTNO}" maxlength="255" placeholder="这里输入料号" title="料号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">品牌:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">数量:</td>
								<td><input type="number" name="QTY" id="QTY" value="${pd.QTY}" maxlength="32" placeholder="这里输入数量" title="数量" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">美元单价:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">单价人民币:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">单价港币:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">包装形式:</td>
							...
							<tr>
								<td style="width:175px;text-align: right;padding-top: 13px;">运输方式:</td>

		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="customerinfo/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CUSTOMERINFO_ID" id="CUSTOMERINFO_ID" value="${pd.CUSTOMERINFO_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">客户ID:</td>
								<td><input type="text" name="CUSTOMER_ID" id="CUSTOMER_ID" value="${pd.CUSTOMER_ID}" maxlength="255" placeholder="这里输入客户ID" title="客户ID" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">客户名称:</td>
								<td><input type="text" name="CUSTOMERNAME" id="CUSTOMERNAME" value="${pd.CUSTOMERNAME}" maxlength="255" placeholder="这里输入客户名称" title="客户名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">户口名称缩写:</td>
								<td><input type="text" name="CUSTOMERNAME_ABBRE" id="CUSTOMERNAME_ABBRE" value="${pd.CUSTOMERNAME_ABBRE}" maxlength="255" placeholder="这里输入户口名称缩写" title="户口名称缩写" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			if($("#CUSTOMERNAME_ABBRE").val()==""){
				$("#CUSTOMERNAME_ABBRE").tips({
					side:3,
		            msg:'请输入户口名称缩写',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#CUSTOMERNAME_ABBRE").focus();
			return false;
			}
			if($("#BANKNAME").val()==""){
				$("#BANKNAME").tips({

		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="purdetail/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="PURDETAIL_ID" id="PURDETAIL_ID" value="${pd.PURDETAIL_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">USD:</td>
								<td><input type="number" name="UNITUSD" id="UNITUSD" value="${pd.UNITUSD}" maxlength="32" placeholder="这里输入USD" title="USD" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">UNITcny:</td>
								<td><input type="number" name="UNITCNY" id="UNITCNY" value="${pd.UNITCNY}" maxlength="32" placeholder="这里输入UNITcny" title="UNITcny" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">UNIThkd:</td>
								<td><input type="number" name="UNITHKD" id="UNITHKD" value="${pd.UNITHKD}" maxlength="32" placeholder="这里输入UNIThkd" title="UNIThkd" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">排序:</td>
								<td><input type="text" name="DETAILORDER" id="DETAILORDER" value="${pd.DETAILORDER}" maxlength="10" placeholder="这里输入排序" title="排序" style="width:98%;"/></td>
							</tr>
							<tr>
